...
public final class Entitlement extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Output only. The offer duration of the new offer in ISO 8601 duration format. Field is empty if
   * the pending plan change is not moving to an offer since the entitlement is not pending, only
   * the plan change is pending.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * empty if entitlement was not made using an offer.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
   ...
   * product, quote, or offer. It is highly recommended to use the more explicit fields
   * productExternalName, quoteExternalName, or offer listed below based on your needs.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
