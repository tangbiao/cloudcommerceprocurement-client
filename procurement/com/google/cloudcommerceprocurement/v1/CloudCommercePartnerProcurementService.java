...
public class CloudCommercePartnerProcurementService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Providers {
    ...
    public class Accounts {
       ...
       *
       * @param name The resource name of the account. Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.ResetAccountRequest}
       * @return the request
       */
      public Reset reset(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ResetAccountRequest content) throws java.io.IOException {
        Reset result = new Reset(name, content);
        initialize(result);
        return result;
      }

      public class Reset extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
         ...
         * @since 1.13
         */
        protected Reset(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ResetAccountRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
